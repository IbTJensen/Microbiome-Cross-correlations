...
R <- foreach(
  ...
  mae_CEV <- data.table(Opt[i,],
                        MAE_nonzero=mae(true.cor[true.cor!=0], CEV[true.cor!=0]),
                        MAE_zero=mae(true.cor[true.cor==0], CEV[true.cor==0]),
                        Method = "SparCEV")
...
ggsave(filename = "Figures/SFig2_div.pdf", g_zero, width = 150, height = 160, unit = "mm")
